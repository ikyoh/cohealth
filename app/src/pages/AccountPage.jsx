        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-5">
                ...
                <div className="card-shadow col-span-4 items-center relative">
                    <div className="relative mt-1 flex h-20 w-full justify-center rounded-xl bg-cover" style={{ backgroundImage: `url(${banner})` }}>
                        {account && account.avatar ?

                            <img src={URL + account.avatar.contentUrl} className='object-cover absolute -bottom-12 h-[87px] w-[87px] rounded-full border-[4px] border-white' alt="profil" />
                            :
                    ...
                    <div className="mt-8 flex flex-col items-center">
                        <h4 className="text-xl font-bold">{account.firstname} {account.lastname}</h4>
                        <p className="font-xs text-slate-400">
                            {account.roles.includes("ROLE_NURSE") && "Infirmièr(e)"}
                            {account.roles.includes("ROLE_DOCTOR") && "Médecin"}
                            {account.roles.includes("ROLE_PHYSIO") && "Physiothérapeute"}
                        </p>
                    </div>
                    ...
                    <div className='flex justify-center mt-5'>
                        <div className='cursor-pointer overflow-hidden'
                            ...
                            {account && account.signature
                                ? <img src={URL + account.signature.contentUrl} className='object-cover w-[250px] max-w-full' alt="profil" />
                    ...
                    <div className="flex flex-col gap-3">
                        <button
                            ...
                            onClick={() => handleOpenModal({
                                title: 'Ma signature', content: <AccountMediaForm id={account.signature ? account.signature.id : false} type="signature"
