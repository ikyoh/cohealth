 ...
 */
final class Version20230211145334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assurance CHANGE type type VARCHAR(20) NOT NULL');
        $this->addSql('ALTER TABLE mission CHANGE patient_id patient_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assurance CHANGE type type VARCHAR(10) NOT NULL');
        $this->addSql('ALTER TABLE mission CHANGE patient_id patient_id INT NOT NULL');
    }
}
